...
public class N11Select extends PageElementModel {
    private static final Log log = LogFactory.getLog(N11Select.class);

    public N11Select(selectorNames selectorName, String selectorValue) {
