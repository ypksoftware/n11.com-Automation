...
public class N11CheckBox extends PageElementModel {
    private static final Log log = LogFactory.getLog(N11CheckBox.class);

    public N11CheckBox(selectorNames selectorName, String selectorValue) {
