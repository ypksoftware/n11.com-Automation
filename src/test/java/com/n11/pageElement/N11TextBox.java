...
public class N11TextBox extends PageElementModel {
    private static final Log log = LogFactory.getLog(N11TextBox.class);

    public N11TextBox(selectorNames selectorName, String selectorValue) {
